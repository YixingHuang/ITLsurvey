...
if data == 0: # training folder:
    ...
    save_folder = 'C:/Data/RetinalData2/Training_Set/Training_Set/preprocessedBinary/'
    ...
    save_folder = 'C:/Data/RetinalData2/Test_Set/Test_Set/preprocessedBinary/'
    ...
    save_folder = 'C:/Data/RetinalData2/Evaluation_Set/Evaluation_Set/preprocessedBinary/'
...
for row in csv_reader:
    ...
    directory = save_folder + camera_size_name + '/' + str(disease_type) + '/'
