...
if data == 0: # training folder:
    ...
    save_folder = 'C:/Data/RetinalData2/Training_Set/Training_Set/preprocessedDR/'
    ...
    save_folder = 'C:/Data/RetinalData2/Test_Set/Test_Set/preprocessedDR/'
    ...
    save_folder = 'C:/Data/RetinalData2/Evaluation_Set/Evaluation_Set/preprocessedDR/'
else:
...
for row in csv_reader:
    ...
    directory = save_folder + camera_size_name + '/' + str(disease_type) + "_" + new_disease_names[disease_type] + '/'
