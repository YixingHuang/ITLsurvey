...
def parse_model_name(models_root_path, model_name, input_size, num_classes):
    """
    ...
    if "alexnet" in model_name:
        ...
        base_model = SmallVGG9(models_root_path, input_size, model_name, create=True, num_classes=num_classes)
    elif WideVGG9.vgg_config in model_name:
        base_model = WideVGG9(models_root_path, input_size, model_name, create=True, num_classes=num_classes)
    elif DeepVGG22.vgg_config in model_name:
        base_model = DeepVGG22(models_root_path, input_size, model_name, create=True, num_classes=num_classes)
    elif BaseVGG9.vgg_config in model_name:
        base_model = BaseVGG9(models_root_path, input_size, model_name, create=True, num_classes=num_classes)
    else:
...
# FUNCTIONS
############################################################
def make_VGGmodel(last_featmap_size, name, path, classifier, final_featmap_count, batch_norm, dropout, num_classes=10):
    """
    ...
    model = VGGcreator.VGGSlim(config=name, num_classes=num_classes,
