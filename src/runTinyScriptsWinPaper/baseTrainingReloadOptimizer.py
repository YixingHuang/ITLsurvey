...
# cmd0 = 'py ../framework/main.py small_VGG9_cl_128_128  --gridsearch_name base_training_reloadOp --method_name  joint  --ds_name tiny    --test  --test_overwrite_mode    --num_epochs 50 --n_iters 1  --first_task_basemodel_folder first_task_base_training_reloadOp    --optimizer 0  --fixed_init_lr 0.05 --num_class 10  --lr_grid 0.1,5e-2,1e-2,5e-3,1e-3,5e-4,1e-4'
...
cmd4 = 'py ../framework/main.py small_VGG9_cl_128_128  --gridsearch_name base_training_reloadOp --method_name  EWC  --ds_name tiny    --test  --test_overwrite_mode    --num_epochs 50 --n_iters 1  --first_task_basemodel_folder first_task_base_training_reloadOp    --optimizer 0  --fixed_init_lr 0.05 --num_class 10 --multi_head --no_maximal_plasticity_search --hyperparams_seq 0,10,10,10,10'

cmd5 = 'py ../framework/main.py small_VGG9_cl_128_128  --gridsearch_name base_training_reloadOp --method_name  LWF  --ds_name tiny    --test  --test_overwrite_mode    --num_epochs 50 --n_iters 1  --first_task_basemodel_folder first_task_base_training_reloadOp    --optimizer 0  --fixed_init_lr 0.05 --num_class 10 --multi_head --no_maximal_plasticity_search'

cmd6 = 'py ../framework/main.py small_VGG9_cl_128_128  --gridsearch_name base_training_reloadOp --method_name  MAS --ds_name tiny    --test  --test_overwrite_mode    --num_epochs 50 --n_iters 1  --first_task_basemodel_folder first_task_base_training_reloadOp    --optimizer 0  --fixed_init_lr 0.05 --num_class 10 --multi_head --no_maximal_plasticity_search'

cmd7 = 'py ../framework/main.py small_VGG9_cl_128_128  --gridsearch_name base_training_reloadOp --method_name  meanIMM --ds_name tiny    --test  --test_overwrite_mode    --num_epochs 50 --n_iters 1 --seed 7  --first_task_basemodel_folder first_task_base_training_reloadOp  --optimizer 0  --fixed_init_lr 0.05 --num_class 10 --multi_head --no_maximal_plasticity_search' #Methods Line 819 No_fremework True

cmd8 = 'py ../framework/main.py small_VGG9_cl_128_128  --gridsearch_name base_training_reloadOp --method_name  modeIMM --ds_name tiny    --test  --test_overwrite_mode    --num_epochs 50 --n_iters 1 --seed 7  --first_task_basemodel_folder first_task_base_training_reloadOp  --optimizer 0  --fixed_init_lr 0.05 --num_class 10 --multi_head --no_maximal_plasticity_search'
