...
cmd2 = 'py ../framework/main.py small_VGG9_cl_128_128  --gridsearch_name AdamSWT_N3 --method_name  FT  --ds_name tiny   --test  --test_overwrite_mode --num_epochs 50 --n_iters 1  --first_task_basemodel_folder  first_task_AdamSWT_N3 --optimizer 1  --fixed_init_lr 0.001 --num_class 10  --no_maximal_plasticity_search'
...
cmd4 = 'py ../framework/main.py small_VGG9_cl_128_128  --gridsearch_name AdamSWT_N3 --method_name  EWC  --ds_name tiny   --test  --test_overwrite_mode --num_epochs 50 --n_iters 1  --first_task_basemodel_folder  first_task_AdamSWT_N3 --optimizer 1  --fixed_init_lr 0.05 --num_class 10  --no_maximal_plasticity_search'
...
cmd6 = 'py ../framework/main.py small_VGG9_cl_128_128  --gridsearch_name AdamSWT_N3 --method_name  MAS --ds_name tiny   --test  --test_overwrite_mode --num_epochs 50 --n_iters 1  --first_task_basemodel_folder  first_task_AdamSWT_N3 --optimizer 1  --fixed_init_lr 0.001 --num_class 10   --no_maximal_plasticity_search'
