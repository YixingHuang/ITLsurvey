...
cmd1 = 'py  ../framework/main.py small_VGG9_cl_128_128  --runmode first_task_basemodel_dump --gridsearch_name AdamCWT_N5 --method_name SI --ds_name tiny   --num_epochs 10  --first_task_basemodel_folder  first_task_AdamCWT_N5 --optimizer 1  --fixed_init_lr 0.001  --num_class 10  --no_maximal_plasticity_search'
...
cmd4 = 'py ../framework/main.py small_VGG9_cl_128_128  --gridsearch_name AdamCWT_N5 --method_name  EWC  --ds_name tiny   --test  --test_overwrite_mode --num_epochs 10 --n_iters 5  --first_task_basemodel_folder  first_task_AdamCWT_N5 --optimizer 1  --fixed_init_lr 0.05 --num_class 10  --no_maximal_plasticity_search'
...
cmd6 = 'py ../framework/main.py small_VGG9_cl_128_128  --gridsearch_name AdamCWT_N5 --method_name  MAS --ds_name tiny   --test  --test_overwrite_mode --num_epochs 10 --n_iters 5  --first_task_basemodel_folder  first_task_AdamCWT_N5 --optimizer 1  --fixed_init_lr 0.001 --num_class 10   --no_maximal_plasticity_search'
