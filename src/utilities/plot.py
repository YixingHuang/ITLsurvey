...
def plot_line_horizontal_sequence(plots_data, colors, linestyles, labels, markers, markersizes, save_img_path=None,
                                  ...
                                  y_label_fontsize=19,
                                  xlabel="Training Sequence Per Center",
                                  x_label_fontsize=19,
                                  start_y_zero=False,
                                  labelmode='minor',
    ...
    if labelmode == 'major':
        ...
        for idx, task_idx in enumerate(task_idxs):
            ...
            Xtick_labels.append('C{}'.format((task_idx + 1) % panel_length))
            if offset_idx > 0:
...
def plot_line_horizontal_sequence_icl(plots_data, colors, linestyles, labels, markers, markersizes, save_img_path=None,
                                  ylim=None,
                                  legend="out",
                                  ylabel="Accuracy % after learning all tasks",
                                  y_label_fontsize=19,
